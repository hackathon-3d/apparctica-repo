...
-(id) init
{
	...
	if( (self=[super init]) ) {
        ...
        self->_correct_band = 100 + [self randomFloatBetween:50 big:150];
        self->_is_visible = true;
        self->_is_locked = false;
        self->_rate_of_growth = [self randomFloatBetween:0.8 big:2];
...
- (float)randomFloatBetween:(float)smallNumber big:(float)bigNumber {
